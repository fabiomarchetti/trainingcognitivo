/**
 * Esercizio: movimento corpo youtube
 * Categoria: strumenti
 *
 * ascolta la musica e vedi video youtube con il movimento delle parti del corpo
 */
'use client'
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <header className="bg-white shadow-md p-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <h1 className="text-xl font-bold text-gray-800">movimento corpo youtube</h1>
